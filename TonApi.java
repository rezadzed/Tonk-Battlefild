...
public class TonApi {
    ...
    public static class WalletV4AccountState extends AccountState {
        public long walletId;
        public int seqno;
         ...
         * 
         */
        public WalletV4AccountState() {
        }

        public WalletV4AccountState(long walletId, int seqno) {
            this.walletId = walletId;
            this.seqno = seqno;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -735144074;
     ...
     * 
     */
    public static class ExtraCurrency extends Object {
        public int id;
        public long amount;
         ...
         * 
         */
        public ExtraCurrency() {
        }

        public ExtraCurrency(int id, long amount) {
            this.id = id;
            this.amount = amount;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = 347022801;
    ...
    public static class FullAccountState extends Object {
        ...
        public long balance;
        public ExtraCurrency[] extraCurrencies;
        ...
        public FullAccountState(AccountAddress address, long balance, ExtraCurrency[] extraCurrencies, InternalTransactionId lastTransactionId, TonBlockIdExt blockId, long syncUtime, AccountState accountState, int revision) {
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -676896151;
    ...
    public static class WalletV4InitialAccountState extends InitialAccountState {
        public String publicKey;
        public long walletId;
         ...
         * 
         */
        public WalletV4InitialAccountState() {
        }

        public WalletV4InitialAccountState(String publicKey, long walletId) {
            this.publicKey = publicKey;
            this.walletId = walletId;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -789986619;
     ...
     * 
     */
    public static class BlocksOutMsgQueueSize extends Object {
        public TonBlockIdExt id;
        public int size;
         ...
         * 
         */
        public BlocksOutMsgQueueSize() {
        }

        public BlocksOutMsgQueueSize(TonBlockIdExt id, int size) {
            this.id = id;
            this.size = size;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = 1650494287;
     ...
     * 
     */
    public static class BlocksOutMsgQueueSizes extends Object {
        public BlocksOutMsgQueueSize[] shards;
        public int extMsgQueueSizeLimit;

        /**
         * 
         */
        public BlocksOutMsgQueueSizes() {
        }

        public BlocksOutMsgQueueSizes(BlocksOutMsgQueueSize[] shards, int extMsgQueueSizeLimit) {
            this.shards = shards;
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -586969790;
    ...
    public static class MsgMessage extends Object {
        ...
        public MsgMessage(AccountAddress destination, String publicKey, long amount, ExtraCurrency[] extraCurrencies, MsgData data, int sendMode) {
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -1652961002;
    ...
    public static class RawExtMessageInfo extends Object {
        ...
        public RawExtMessageInfo(byte[] hash, byte[] hashNorm) {
            this.hash = hash;
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = 684666851;
    ...
    public static class RawFullAccountState extends Object {
        ...
        public RawFullAccountState(long balance, ExtraCurrency[] extraCurrencies, byte[] code, byte[] data, InternalTransactionId lastTransactionId, TonBlockIdExt blockId, byte[] frozenHash, long syncUtime) {
            this.balance = balance;
            this.extraCurrencies = extraCurrencies;
            this.code = code;
            this.data = data;
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -1002565503;
    ...
    public static class RawMessage extends Object {
        ...
        public RawMessage(byte[] hash, AccountAddress source, AccountAddress destination, long value, ExtraCurrency[] extraCurrencies, long fwdFee, long ihrFee, long createdLt, byte[] bodyHash, MsgData msgData) {
            this.hash = hash;
            this.source = source;
            this.destination = destination;
            this.value = value;
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -399085505;
    ...
    public abstract static class SmcLibraryQueryExt extends Object {
    }

    public static class SmcLibraryQueryExtOne extends SmcLibraryQueryExt {
        public byte[] hash;

        /**
         * 
         */
        public SmcLibraryQueryExtOne() {
        }

        public SmcLibraryQueryExtOne(byte[] hash) {
            this.hash = hash;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = 1680141027;
    ...
    public static class SmcLibraryQueryExtScanBoc extends SmcLibraryQueryExt {
        public byte[] boc;
        public int maxLibs;
         ...
         * 
         */
        public SmcLibraryQueryExtScanBoc() {
        }

        public SmcLibraryQueryExtScanBoc(byte[] boc, int maxLibs) {
            this.boc = boc;
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -548100891;
     ...
     * 
     */
    public static class SmcLibraryResultExt extends Object {
        public byte[] dictBoc;
        public byte[][] libsOk;
        public byte[][] libsNotFound;

        /**
         * 
         */
        public SmcLibraryResultExt() {
        }

        public SmcLibraryResultExt(byte[] dictBoc, byte[][] libsOk, byte[][] libsNotFound) {
            this.dictBoc = dictBoc;
            this.libsOk = libsOk;
            this.libsNotFound = libsNotFound;
        }

        /**
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -1260458638;
     ...
     * 
     *
     * <p> Returns {@link BlocksOutMsgQueueSizes BlocksOutMsgQueueSizes} </p>
     */
    public static class BlocksGetOutMsgQueueSizes extends Function {
        public int mode;
        public int wc;
        public long shard;
         ...
         * <p> Returns {@link BlocksOutMsgQueueSizes BlocksOutMsgQueueSizes} </p>
         */
        public BlocksGetOutMsgQueueSizes() {
        }

        public BlocksGetOutMsgQueueSizes(int mode, int wc, long shard) {
            this.mode = mode;
            this.wc = wc;
            this.shard = shard;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -1187352660;
     ...
     * 
     *
     * <p> Returns {@link SmcLibraryResultExt SmcLibraryResultExt} </p>
     */
    public static class SmcGetLibrariesExt extends Function {
        public SmcLibraryQueryExt[] list;
         ...
         * <p> Returns {@link SmcLibraryResultExt SmcLibraryResultExt} </p>
         */
        public SmcGetLibrariesExt() {
        }

        public SmcGetLibrariesExt(SmcLibraryQueryExt[] list) {
            this.list = list;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = 931219762;
     ...
     * <p> Returns {@link RawFullAccountState RawFullAccountState} </p>
     */
    public static class SmcGetRawFullAccountState extends Function {
        public long id;
         ...
         * <p> Returns {@link RawFullAccountState RawFullAccountState} </p>
         */
        public SmcGetRawFullAccountState() {
        }

        public SmcGetRawFullAccountState(long id) {
            this.id = id;
        }
         ...
         * Identifier uniquely determining type of the object.
         */
        public static final int CONSTRUCTOR = -672334072;
